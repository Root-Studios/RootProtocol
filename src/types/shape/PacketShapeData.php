...
final class PacketShapeData{
	...
	public static function text(int $networkId, Vector3 $location, string $text, bool $useRotation = false, ?Color $backgroundColor = null, bool $depthTest = true, bool $showBackface = true, bool $showTextBackface = true, ?float $lineHeightOverride = null, ?Color $color = null, ?int $dimensionId = null, ?int $attachedToEntityId = null) : self{
		return new self(
			networkId: $networkId,
			...
			dimensionId: $dimensionId,
			attachedToEntityId: $attachedToEntityId,
			payload: new PrimitiveShapeTextPayload($text, $useRotation, $backgroundColor, $depthTest, $showBackface, $showTextBackface, $lineHeightOverride)
		);
	}
